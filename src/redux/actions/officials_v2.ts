...
import {
  POST_OFFICIAL_V2_STARTED,
  POST_OFFICIAL_V2_SUCCESSFUL,
  POST_OFFICIAL_V2_FAILED,
  GET_OFFICIAL_V2_STARTED,
  GET_OFFICIAL_V2_SUCCESSFUL,
  GET_OFFICIAL_V2_FAILED,
  GET_OFFICIALS_V2_STARTED,
  GET_OFFICIALS_V2_SUCCESSFUL,
  GET_OFFICIALS_V2_FAILED,
  UPDATE_OFFICIAL_V2_STARTED,
  UPDATE_OFFICIAL_V2_SUCCESSFUL,
  UPDATE_OFFICIAL_V2_FAILED,
  ACCREDIT_OFFICIAL_V2_STARTED,
  ACCREDIT_OFFICIAL_V2_SUCCESSFUL,
  ACCREDIT_OFFICIAL_V2_FAILED
} from "./actionTypes";
import { privateHttp, http } from "../../baseUrl";
import { ErrorPopUp, SuccessPopUp } from "../../utils/toastify";

const start = () => ({
  type: POST_OFFICIAL_V2_STARTED
})

const postOfficialSuccess = (data: IOfficial) => ({
  type: POST_OFFICIAL_V2_SUCCESSFUL,
  payload: data
})

const postOfficialFailed = (data: any) => ({
  type: POST_OFFICIAL_V2_FAILED,
  payload: data
})

const getOfficialStarted = () => ({
  type: GET_OFFICIAL_V2_STARTED
})

const getOfficialSuccess = (data: IOfficial) => ({
  type: GET_OFFICIAL_V2_SUCCESSFUL,
  payload: data
})

const getOfficialFailed = (data: any) => ({
  type: GET_OFFICIAL_V2_FAILED,
  payload: data
})

const getOfficialsStarted = () => ({
  type: GET_OFFICIALS_V2_STARTED
})

const getOfficialsSuccess = (data: IOfficial) => ({
  type: GET_OFFICIALS_V2_SUCCESSFUL,
  payload: data
})

const getOfficialsFailed = (data: any) => ({
  type: GET_OFFICIALS_V2_FAILED,
  payload: data
})

const updateOfficerStarted = () => ({
  type: UPDATE_OFFICIAL_V2_STARTED
})

const updateOfficialSuccess = (data: IOfficial) => ({
  type: UPDATE_OFFICIAL_V2_SUCCESSFUL,
  payload: data
});

const updateOfficialFailed = (data: any) => ({
  type: UPDATE_OFFICIAL_V2_FAILED,
  payload: data
});

const accreditOfficialStarted = () => ({
  type: ACCREDIT_OFFICIAL_V2_STARTED
});

const accreditOfficialSuccess = (data: IPlayer) => ({
  type: ACCREDIT_OFFICIAL_V2_SUCCESSFUL,
  payload: data,
});

const accreditOfficialFailed = (data: any) => ({
  type: ACCREDIT_OFFICIAL_V2_FAILED,
  payload: data,
});
